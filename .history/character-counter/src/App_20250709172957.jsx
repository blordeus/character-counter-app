    ...
    <div className={`min-h-screen ${theme === "light" ? "bg-[var(--color-bg)]" : "bg-gray-900 text-white"} flex flex-col items-center justify-center p-4 sm:p-6 transition-colors duration-300`}>
      <div className="w-full max-w-4xl">
        <header className="flex justify-between items-center mb-8">
          <img
            src={theme === "light" ? ".public/assets/images/logo-light-theme.svg" : "./assets/images/logo-dark-theme.svg"} // Use the appropriate logo based on the theme/assets/logo-light.svg" : "/assets/logo-dark.svg"}
