    ...
    <div className="w-full mb-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div className="p-6 bg-[var(--color-card)] dark:bg-gray-800 rounded-lg shadow-md flex justify-between items-center">
        <p className="text-4xl font-bold text-[var(--color-text)] dark:text-gray-200">
          Characters <span className={charCount > charLimit ? "text-red-500 font-medium text-2xl" : "font-medium text-2xl"}>{charCount}</span> / {charLimit}
        </p>
      ...
      <div className="p-6 bg-[var(--color-card)] dark:bg-gray-800 rounded-lg shadow-md flex justify-between items-center">
        <p className="text-4xl font-bold text-[var(--color-text)] dark:text-gray-200">
          Words <span className="font-medium text-2xl">{wordCount}</span>
        </p>
      ...
      <div className="p-6 bg-[var(--color-card)] dark:bg-gray-800 rounded-lg shadow-md flex justify-between items-center">
        <p className="text-4xl font-bold text-[var(--color-text)] dark:text-gray-200"> <br/>
          {sentenceCount} <span className="font-medium text-2xl">Sentences</span>
        </p>
      ...
      <div className="p-6 bg-[var(--color-card)] dark:bg-gray-800 rounded-lg shadow-md flex justify-between items-center">
        ...
        <svg className="w-48 h-48 text-[var(--color-neutral-700)] translate-x-5" fill="none" stroke="#f56" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
