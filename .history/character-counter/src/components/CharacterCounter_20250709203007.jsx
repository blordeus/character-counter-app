function CharacterCounter({ text, setText, includeSpaces, setIncludeSpaces, charLimit, setCharLimit }) {
  ...
  return (
    <div className="w-full mb-8">
      <textarea
        className="bg-neutral-100 w-full p-4 border border-[var(--color-border)] rounded-lg resize-y focus:outline-none focus:ring-2 focus:ring-blue-400 shadow-sm  dark:border-gray-600 dark:text-black placeholder-neutral-400 dark:bg-gray-700 dark:placeholder-gray-400"
        value={text}
