        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <label className="flex items-center text-[var(--color-text)] dark:text-gray-200 text-base">
            <input
              ...
              className="mr-2 h-4 w-4 text-blue-500 focus:ring-blue-400 border-[var(--color-border)] rounded active:bg-purple-400 focus:outline-noneay-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
