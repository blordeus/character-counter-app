function CharacterCounter({ text, setText, includeSpaces, setIncludeSpaces, charLimit, setCharLimit }) {
  ...
  return (
    <div className="w-full mb-8">
      <textarea
        className="w-full p-4 border border-[var(--color-border)] rounded-lg resize-y focus:outline-none focus:ring-2 focus:ring-blue-400 shadow-sm dark:bg-gray-800 dark:border-gray-600 dark:text-black placeholder-[var(--color-neutral-600)]"
        value={text}
