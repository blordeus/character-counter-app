function CharacterCounter({ text, setText, includeSpaces, setIncludeSpaces, charLimit, setCharLimit }) {
  ...
  return (
    <div className="w-full mb-8">
      <textarea
        className="bg-neutral-100 dark:placeholder: w-full p-4 border border-[var(--color-border)] rounded-lg resize-y focus:outline-none focus:ring-2 focus:ring-blue-400 shadow-sm dark:bg-gray-800 dark:border-gray-600 dark:text-white placeholder-[var(--color-placeholder)]"
        value={text}
