        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex items-center">
            ...
            <input
              ...
              className="w-20 p-2 border border-[var(--color-border)] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 dark:[bg-gray-700] text-[var(--color-text)] dark:text-gray-200 "
