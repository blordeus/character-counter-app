  ...
  return (
    <div className="w-full mb-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div className="p-6 bg-[var(--color-card)] dark:bg-gray-800 rounded-lg shadow-md flex justify-between items-center">
        <p className={charCount > charLimit ? "text-red-500 font-medium text-2xl" : "font-medium text-2xl"}>
          CHARACTERS <spanclassName="text-4xl font-bold text-[var(--color-text)] dark:text-gray-200" >{charCount}</spanclassName=> / {charLimit}
        </p>
