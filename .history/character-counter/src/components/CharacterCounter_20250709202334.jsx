...
line-none focus:ring-2 focus:ring-blue-400 shadow-sm dark:bg-gray-800 dark:border-gray-600 dark:text-white placeholder-[var(--color-placeholder)]"
        val      <textarea
        className="w-full p-4 border border-[var(--color-border)] rounded-lg resize-y focus:outue={text}
