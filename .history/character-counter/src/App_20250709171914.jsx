    ...
    <div className={`min-h-screen ${theme === "light" ? "bg-[var(--color-bg)]" : "bg-gray-900 text-white"} flex flex-col items-center justify-center p-4 sm:p-6 transition-colors duration-300`}>
      <div className="w-full max-w-4xl">
        <header className="flex justify-between items-center mb-8">
          <img
            src={theme === "light" ? "./assets/images/logo-light-theme.png" : "./assets/images/logo-dark-theme.png"} // Use the appropriate logo based on the theme/assets/logo-light.svg" : "/assets/logo-dark.svg"}
            alt="Character Counter Logo"
            className="h-10"
          />
          <ThemeSwitcher theme={theme} setTheme={setTheme} />
        </header>
        <h1 className="text-4xl sm:text-5xl font-bold text-[var(--color-text)] dark:text-gray-100 mb-8 text-center">Character Counter</h1>
        <CharacterCounter
          text={text}
          setText={setText}
